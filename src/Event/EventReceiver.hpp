...
<<<<<<< HEAD
    ...
    float getFuelLiter() {   return m_fuelLiter / 150.0f;    }
=======
    float getAltitudeSpeed(){   return fromKmToMS((m_rotationAngle/90) * fromKtToKmH(fromGameUnitToKt(m_planeSpeedFloor))); }
